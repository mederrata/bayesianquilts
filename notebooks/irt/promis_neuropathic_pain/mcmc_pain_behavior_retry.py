#!/usr/bin/env python
"""Retry NP pain_behavior with larger step size."""
import os, sys
...
# Try MALA instead of NUTS for this difficult posterior
print("\n--- MALA ---")
mcmc_samples = model.fit_marginal_mala(
    data, theta_grid=None,
    num_chains=4, num_warmup=5000, num_samples=2000,
    step_size=1e-4, seed=42, verbose=True,
)
