...
DATASET_CONFIGS = {
    ...
    # Per-domain unidim PROMIS GRMs
    'promis_np__pain_interference':  {'module': 'bayesianquilts.data.promis_neuropathic_pain', 'domain': 'pain_interference', 'n_top_features': 30},
    'promis_np__pain_behavior':      {'module': 'bayesianquilts.data.promis_neuropathic_pain', 'domain': 'pain_behavior',     'n_top_features': 30},
    'promis_np__global_health':      {'module': 'bayesianquilts.data.promis_neuropathic_pain', 'domain': 'global_health',     'n_top_features': 10},
    'promis_copd__depression':         {'module': 'bayesianquilts.data.promis_copd', 'domain': 'depression',         'n_top_features': 28},
    'promis_copd__anxiety':            {'module': 'bayesianquilts.data.promis_copd', 'domain': 'anxiety',            'n_top_features': 29},
    'promis_copd__anger':              {'module': 'bayesianquilts.data.promis_copd', 'domain': 'anger',              'n_top_features': 29},
    'promis_copd__fatigue_experience': {'module': 'bayesianquilts.data.promis_copd', 'domain': 'fatigue_experience', 'n_top_features': 30},
    'promis_copd__fatigue_impact':     {'module': 'bayesianquilts.data.promis_copd', 'domain': 'fatigue_impact',     'n_top_features': 30},
    'promis_copd__pain_interference':  {'module': 'bayesianquilts.data.promis_copd', 'domain': 'pain_interference',  'n_top_features': 30},
    'promis_copd__pain_behavior':      {'module': 'bayesianquilts.data.promis_copd', 'domain': 'pain_behavior',      'n_top_features': 30},
    'promis_copd__physical_function':  {'module': 'bayesianquilts.data.promis_copd', 'domain': 'physical_function',  'n_top_features': 30},
    'promis_copd__social_satisfaction':{'module': 'bayesianquilts.data.promis_copd', 'domain': 'social_satisfaction','n_top_features': 26},
    # PROMIS Substance Use sub-banks (correlation-derived)
    'promis_su__bank1': {'module': 'bayesianquilts.data.promis_substance_use', 'bank': 'bank1', 'n_top_features':  9},
    'promis_su__bank2': {'module': 'bayesianquilts.data.promis_substance_use', 'bank': 'bank2', 'n_top_features': 15},
    'promis_su__bank3': {'module': 'bayesianquilts.data.promis_substance_use', 'bank': 'bank3', 'n_top_features': 30},
    'promis_su__bank4': {'module': 'bayesianquilts.data.promis_substance_use', 'bank': 'bank4', 'n_top_features': 30},
    'promis_su__bank5': {'module': 'bayesianquilts.data.promis_substance_use', 'bank': 'bank5', 'n_top_features': 30},
    'promis_su__bank6': {'module': 'bayesianquilts.data.promis_substance_use', 'bank': 'bank6', 'n_top_features': 22},
    # PROMIS 1 Wave 1 calibration (14 health domains)
    'promis_w1__alcohol_use':         {'module': 'bayesianquilts.data.promis_wave1', 'domain': 'alcohol_use',         'n_top_features': 30},
    'promis_w1__anger':               {'module': 'bayesianquilts.data.promis_wave1', 'domain': 'anger',               'n_top_features': 30},
    'promis_w1__anxiety':             {'module': 'bayesianquilts.data.promis_wave1', 'domain': 'anxiety',             'n_top_features': 30},
    'promis_w1__depression':          {'module': 'bayesianquilts.data.promis_wave1', 'domain': 'depression',          'n_top_features': 30},
    'promis_w1__fatigue_experience':  {'module': 'bayesianquilts.data.promis_wave1', 'domain': 'fatigue_experience',  'n_top_features': 30},
    'promis_w1__fatigue_impact':      {'module': 'bayesianquilts.data.promis_wave1', 'domain': 'fatigue_impact',      'n_top_features': 30},
    'promis_w1__pain_behavior':       {'module': 'bayesianquilts.data.promis_wave1', 'domain': 'pain_behavior',       'n_top_features': 30},
    'promis_w1__pain_interference':   {'module': 'bayesianquilts.data.promis_wave1', 'domain': 'pain_interference',   'n_top_features': 30},
    'promis_w1__pain_quality':        {'module': 'bayesianquilts.data.promis_wave1', 'domain': 'pain_quality',        'n_top_features': 30},
    'promis_w1__physical_function_a': {'module': 'bayesianquilts.data.promis_wave1', 'domain': 'physical_function_a', 'n_top_features': 30},
    'promis_w1__physical_function_b': {'module': 'bayesianquilts.data.promis_wave1', 'domain': 'physical_function_b', 'n_top_features': 30},
    'promis_w1__physical_function_c': {'module': 'bayesianquilts.data.promis_wave1', 'domain': 'physical_function_c', 'n_top_features': 30},
    'promis_w1__social_personal':     {'module': 'bayesianquilts.data.promis_wave1', 'domain': 'social_personal',     'n_top_features': 30},
    'promis_w1__social_satisfaction': {'module': 'bayesianquilts.data.promis_wave1', 'domain': 'social_satisfaction', 'n_top_features': 30},
}
