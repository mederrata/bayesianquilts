"""Adult v32: v30 + age×education interaction (EBM's top interaction at 0.077)."""
import sys
...
def run_adult():
    print("ADULT V32 - v30 + age×education interaction (EBM's top at 0.077)")
    print("="*70)
    ...
    print(f"Adding age×education interaction (EBM's top)")
    ...
    for fold_idx, (train_idx, test_idx) in enumerate(kfold.split(np.zeros(N), y)):
        ...
        # Base lattice - remove age since it's in age×edu interaction
        dims_base = [
        ...
        # age × education (EBM's top interaction)
        ...
        def loss_fn(params):
            ...
            intercept = base_vals + age_edu_vals + occ_vals + edu_vals + rel_vals + occ_main + hours_main + rel_main
            ...
            l2_reg = 0.0
            for key in ["base", "age_edu", "occ_hours", "edu_hours", "rel_cg", "beta"]:
