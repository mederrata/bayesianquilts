"""Adult v30: Finer bins (8) with joint training (no boosting)."""
import sys
...
def run_adult():
    print("ADULT V30 - Finer bins (8) with joint training")
    print("="*70)
    ...
    # FINER bins - 8 bins for continuous variables
    ...
    print(f"Joint training of all components")
    ...
    for fold_idx, (train_idx, test_idx) in enumerate(kfold.split(np.zeros(N), y)):
        ...
        # Interaction terms with finer hours bins
        ...
        # Main effects for variables in interaction terms
