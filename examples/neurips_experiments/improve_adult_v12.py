"""Adult v12: Age in beta lattice for true piecewise linear age effect."""
import sys
...
def run_adult():
    print("ADULT V12 - Age in beta lattice for piecewise linear")
    ...
    # Numeric features: non-binned stay raw, binned use normalized
    ...
    print(f"Numeric features: fnlwgt, capital-loss, age_norm, edu_norm, hours_norm, cg_norm")
    print("Key: age in BOTH intercept AND beta lattice for piecewise linear")
    ...
    for fold_idx, (train_idx, test_idx) in enumerate(kfold.split(X_numeric, y)):
        ...
        # Beta: age × marital - age in beta for piecewise linear slope on age_norm
        ...
        if fold_idx == 0:
            ...
            print(f"\n    Intercept cells: {total_cells_int}, Beta cells: {total_cells_beta}")
