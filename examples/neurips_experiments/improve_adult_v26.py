"""Adult v26: Add occupation/education/workclass as features too (linear + lattice)."""
import sys
...
def run_adult():
    print("ADULT V26 - Add occupation/education/workclass as features too")
    print("="*70)
    ...
    print(f"  + occupation/education/workclass as linear features")
    ...
    for fold_idx, (train_idx, test_idx) in enumerate(kfold.split(np.zeros(N), y)):
        ...
        # Include occupation, education, workclass as one-hot features
