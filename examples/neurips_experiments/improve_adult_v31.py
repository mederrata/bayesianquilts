"""Adult v31: v30 + marital×occupation interaction (EBM found 0.038 importance)."""
import sys
...
def run_adult():
    print("ADULT V31 - v30 + marital×occupation interaction")
    print("="*70)
    ...
    print(f"Adding marital×occupation interaction")
    ...
    for fold_idx, (train_idx, test_idx) in enumerate(kfold.split(np.zeros(N), y)):
        ...
        for key, decomp in decomps.items():
            ...
            if key in ["occ_hours", "edu_hours", "rel_cg", "marital_occ"]:
        ...
        def loss_fn(params):
            ...
            intercept = base_vals + occ_vals + edu_vals + rel_vals + marital_occ_vals + occ_main + edu_main + hours_main + rel_main
            ...
            l2_reg = 0.0
            for key in ["base", "occ_hours", "edu_hours", "rel_cg", "marital_occ", "beta"]:
