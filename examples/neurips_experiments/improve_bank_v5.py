"""Bank Marketing v5: v2 structure with less regularization (scale_mult=100)."""
import sys
...
def run_bank():
    print("BANK V5 - v2 structure with less regularization (scale_mult=100)")
    print("="*70)
    ...
    print(f"\nv2 structure with scale_mult=100 (was 50)")
