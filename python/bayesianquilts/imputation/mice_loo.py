...
# Re-export shared model classes from univariate_models for backwards compatibility
from bayesianquilts.imputation.univariate_models import (
    _horseshoe_log_prior,
    _horseshoe_reconstruct_beta,
...
class MICEBayesianLOO(MICELogistic):
    ...
    .. deprecated::
        Use :class:`~bayesianquilts.imputation.pairwise_stacking.PairwiseOrdinalStackingModel`
    ...
    def __init__(
        ...
        import warnings
        warnings.warn(
            "MICEBayesianLOO is deprecated. Use "
            "bayesianquilts.imputation.pairwise_stacking.PairwiseOrdinalStackingModel instead.",
            DeprecationWarning,
            stacklevel=2,
        )
