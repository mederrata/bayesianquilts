"""Noise-regularized affine moment matching for one Bayesian LOO fold.

This module is the correctness-first implementation of PMM1--PMM3.  It uses
three explicit, non-overlapping roles for posterior draws:

* ``fit_draws`` estimate the weighted moment map;
...
def transformed_log_weights(
    ...
    transformed_draws = affine_map(base_draws)
    ...
    log_weights = (
        ...
        - log_full_base
        + affine_map.log_abs_determinant
    )
